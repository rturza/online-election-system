...
<html lang="en">
  ...
  <div class="container">
    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="example-nav-collapse">
          ...
          <span class="normalFont"><a href="index.html" class="btn btn-success navbar-right navbar-btn"> <span class="glyphicon glyphicon-log-in"></span> <strong>&nbsp Sign Out</strong></a></span></button>
        </div>
    ...
    <div class="container" style="padding:100px;">
      <div class="row">
        <!-- <div class="col-sm-12" style="border:2px solid gray;border-radius: 15px"> -->
          ...
          <div class="page-header">
            <h2 class="specialHead">ELECTION CONTROL</h2>
            <p class="normalFont">This is the whole Election System Control Panel. Here, Admin can View and Publish the Entire Election Process !! </p>
          </div>
