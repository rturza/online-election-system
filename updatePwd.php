...
<html lang="en">
  <head>
    ...
    <title>OES | Change Admin Password</title>
  ...
  <body>
    ...
    <div class="container" style="padding-top:150px;">
    	<div class="row">
    		...
    		<div class="col-sm-4 text-center" style="border:2px solid gray; border-radius: 8px; padding:50px;">
...
<?php
	...
	$sql="SELECT * FROM electiondb.admindb WHERE admin_password='".$old."'";
	$query= mysql_query($sql, $conn);
	$rows= mysql_num_rows($query);
	if($rows==1)
	{
		// Given Password is Valid
		$sql="UPDATE electiondb.admindb SET admin_password='$new' WHERE admin_username='admin'"; // =============EDIT *SESSSION_SUERNAME *
