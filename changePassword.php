  ...
  <body>
    ...
    <div class="container" style="padding-top:100px;">
    	<div class="row">
          ...
          <div class="col-sm-4" style="background: linear-gradient(rgba(255,255,255,.3), rgba(255,255,255,.3)), url(images/ecs.png); background-repeat: no-repeat; background-position: center;  background-size: 250px 250px;border:2px solid gray;border-radius: 8px; padding:50px;">
    			
    			<div class="page-header">
    				<h2 class="specialHead">Admin's Change Password</h2>
    			</div>
